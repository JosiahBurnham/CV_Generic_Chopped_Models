...
class VGG_19(): 
    ...
    def __init__(self, wd, num_outputs):
        ...
        self.conv8 = layers.Conv2D(filters=256, kernel_size=(3,3), strides=(1,1), padding='same', activation="relu", name="conv8")
        ...
        self.conv14 = layers.Conv2D(filters=512, kernel_size=(3,3), strides=(1,1), padding='same', activation="relu", name="conv14")
        self.conv15 = layers.Conv2D(filters=512, kernel_size=(3,3), strides=(1,1), padding='same', activation="relu", name="conv15")
        self.conv16 = layers.Conv2D(filters=512, kernel_size=(3,3), strides=(1,1), padding='same', activation="relu", name="conv16")
    ...
    def get_model(self, layer_level):
        ...
        if(layer_level < 22): # if the last layer is not included, add a flatten layer.
            model.add(self.flatten)
